...
GitOps is a key part of how we deploy and manage Telco Core infrastructure at scale, in this section we are going to cover the basics around GitOps and how it is used in Zero Touch Provisioning (ZTP) and ongoing management of OpenShift clusters.
...
You can learn more about OpenShift GitOps {openshift-gitops-docs}[here].
