...
metadata:
  ...
  name: common-core-config-policy
          ...
          objectDefinition:
            ...
            spec:
              ...
              machineConfigPoolSelector:
                pools.operator.machineconfiguration.openshift.io/worker-0: ""
              nodeSelector:
...
metadata:
  name: common-core-config-placementbinding
  namespace: ztp-policies
placementRef:
  apiGroup: apps.open-cluster-management.io
  kind: PlacementRule
  name: common-core-config-placementrules
subjects:
...
As we will detail in the following section link:managing-at-scale.html#inform-policies["Managing at Scale"], for the solution presented in this lab the`PolicyGenerators` are by default set to generate Policies in inform mode.
