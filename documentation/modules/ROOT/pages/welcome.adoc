...
For users without access to the demo platform, an alternative guide for deploying the lab environment is available at xref:lab-environment-ansible.adoc[here].
endif::[]
